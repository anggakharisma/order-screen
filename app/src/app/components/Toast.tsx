  ...
  return (
    <div className={`${isVisible ? "block" : "hidden"} z-50 border-gray-100 border-[1px] block rounded-lg bg-white fixed top-1/4 left-[40%] -translate-x-1/2 py-4 px-8`}>
      ...
      <div className="flex justify-center gap-8 mt-2">
        <button onClick={okFunction} className="bg-emerald-500 p-6 justify-center align-middle items-center gap-2 rounded-lg py-1 flex">Yes <CheckIcon width={18} /></button>
